...
public class MeterDataRequest {
	...
	public MeterDataRequest(Long id,Long meterId, String derivedData, String differenceExpKwh, String differenceImpKwh, String epochTstamp,
